...
export const Anchor = ({children, id}) => (
    <a
        id={id}
        style={{
            color: 'black',
...
export const Rocket = ({children, to}) => (
    <a
        href={'#' + to}
    >
    {children}
...
-   **<Rocket to="class-diagram">Class Diagram</Rocket>** (widely used)
-   Package diagrams
-   Component diagrams
...
-   **<Rocket to="use-case-diagram">Use case diagrams</Rocket>** (widely used)

-   Interaction diagrams

    Focus on **communication** between elements

    -   **<Rocket to="sequence-diagram">Sequence diagrams</Rocket>** (widely used)
...
-   **<Rocket to="state-diagram">State Diagram</Rocket>** (widely used)
...
## <Anchor id="class_diagram">Class Diagram</Anchor>

…



## <Anchor id="use_case_diagram">Use Case Diagram</Anchor>

…



## <Anchor id="sequence_diagram">Sequence diagram</Anchor>
...
## <Anchor id="state_diagram">State Diagram</Anchor>
